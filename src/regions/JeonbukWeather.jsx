...
const cities = ["Jeonju", "Iksan", "Gunsan", "Jeongeup", "Namwon", "Gimje", "Wanju", "Jinan", "Muju", "Sunchang"];
    ...
    return (
      <div style={{ padding: "2rem", textAlign: "center" }}>
        <Helmet>
          ...
          <meta name="description" content="전라북도 주요 도시들의 실시간 날씨 정보를 확인하세요. 전주, 익산, 군산, 정읍, 남원, 김제, 완주, 진안, 무주, 순창 등 10개 도시의 날씨를 제공합니다." />
          <meta name="keywords" content="전라북도날씨, 전라북도기온, 전라북도기상, 전주날씨, 익산날씨, 군산날씨, 정읍날씨, 남원날씨, 김제날씨, 완주날씨, 진안날씨, 무주날씨, 순창날씨" />
